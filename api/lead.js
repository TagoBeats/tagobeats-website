...
const PRODUCTS = {
  tagopitch: {
    name: 'TagoPitch',
    metaLine: 'V1.0.1 &middot; MACOS 11+ AU/VST3 &middot; WINDOWS VST3 &middot; FREE',
    image: 'https://tagobeats.com/uploads_opt/TagoPitch_800.jpg?v=2',
    mac: 'https://github.com/TagoBeats/TagoPitch/releases/download/v1.0.1/TagoPitch-1.0.1.pkg',
    win: 'https://github.com/TagoBeats/TagoPitch/releases/download/v1.0.1/TagoPitch-v1.0.1-Windows-VST3.zip',
  ...
  tagoclip: {
    name: 'TagoClip',
    metaLine: 'V1.1.1 &middot; MACOS 11+ AU/VST3 &middot; WINDOWS VST3 &middot; FREE',
    image: 'https://tagobeats.com/uploads_opt/TagoClip_800.jpg?v=6',
    mac: 'https://github.com/TagoBeats/TagoClip/releases/download/v1.1.1/TagoClip-1.1.1.dmg',
    win: 'https://github.com/TagoBeats/TagoClip/releases/download/v1.1.1/TagoClip-v1.1.1-Windows-VST3.zip',
